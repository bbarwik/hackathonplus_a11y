...
class TestAuthJWTTokenCreateView:
    ...
    @pytest.mark.parametrize('user__password', ['testingpass123'])
    def test_post_returns_HTTP_401_with_error_message_when_password_invalid(
            self,
            client,
            user,
            user__password,
    ...
    def test_post_returns_HTTP_401_with_error_message_when_email_invalid(
            self,
            client,
            user,
            user__password,
    ...
    def test_delete_returns_HTTP_200_when_valid_token_provided(
            self,
            client,
            user,
    ):
    ...
    def test_delete_returns_HTTP_401_when_access_token_not_provided(
            self,
            client,
    ):
    ...
    def test_delete_returns_HTTP_404_when_access_token_owner_does_not_exist(
            self,
            client,
            user_factory,
    ):
